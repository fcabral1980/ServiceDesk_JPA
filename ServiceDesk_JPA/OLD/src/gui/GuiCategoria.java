...
public class GuiCategoria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblTipoImovel = new javax.swing.JTable();
        ...
        setTitle("Cadastro de Tipo de Imóveis");
        ...
        tblTipoImovel.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblTipoImovel.setColumnSelectionAllowed(true);
        tblTipoImovel.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane2.setViewportView(tblTipoImovel);
        tblTipoImovel.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if (tblTipoImovel.getSelectedRow() >= 0) {
            TipoControle controle = new TipoControle();
            Object valor = ((DefaultTableModel) tblTipoImovel.getModel()).getValueAt(tblTipoImovel.getSelectedRow(), 0);
            try {
                Tipo c = controle.getTipoPorId((Long) valor);
    ...
    private javax.swing.JTable tblTipoImovel;
    ...
    private void limparCampos() {
        ...
        tblTipoImovel.clearSelection();
        lblId.setText("");
        tblTipoImovel.removeAll();
    ...
    private void habilitarCampos() {
        ...
        tblTipoImovel.setEnabled(false);
    }

    private void desabilitarCampos() {
        txtNome.setEnabled(false);
        txtDescricao.setEnabled(false);
        tblTipoImovel.setEnabled(true);
    }
    ...
    private void atualizarLista() {
        ...
        TipoControle controle = new TipoControle();
        try {
            controle.atualizarLista(tblTipoImovel);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
        }
    }
