...
import controle.ControleTransporte;
...
public class GuiTransporte extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblTransportes.setColumnSelectionAllowed(true);
        tblTransportes.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane2.setViewportView(tblTransportes);
        tblTransportes.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtTransporte, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGravarActionPerformed
        ControleTransporte controle = new ControleTransporte();

        try {
            Transporte c = new Transporte();
            c.setTransporte(txtTransporte.getText());
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        if (tblTransportes.getSelectedRow() >= 0) {
            ControleTransporte controle = new ControleTransporte();
            Object valor = ((DefaultTableModel) tblTransportes.getModel()).getValueAt(tblTransportes.getSelectedRow(), 0);
            try {
                Transporte c = controle.getTransportePorId((Long) valor);
                txtTransporte.setText(c.getTransporte());
    ...
    private void limparCampos() {
        ...
        tblTransportes.clearSelection();
        lblId.setText("");
        tblTransportes.removeAll();
    ...
    private void habilitarCampos() {
        ...
        tblTransportes.setEnabled(false);
    }

    private void desabilitarCampos() {
        txtTransporte.setEnabled(false);
        txtDescricao.setEnabled(false);
        tblTransportes.setEnabled(true);
    }
    ...
    private void atualizarLista() {
        ...
        ControleTransporte controle = new ControleTransporte();
        try {
            controle.atualizarLista(tblTransportes);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, ex.getMessage());
        }
    }
